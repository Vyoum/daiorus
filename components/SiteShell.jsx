          ...
          <div className="footer-top">
            <div className="footer-brand">
              ...
              <div className="social-links">
                ...
                <a href={PINTEREST_URL} className="social-link" aria-label="Pinterest" target="_blank" rel="noreferrer">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                    <circle cx="12" cy="12" r="9" />
                    <path d="M9.5 14.75c.65 1 1.65 1.5 2.9 1.5 2.3 0 4.1-1.9 4.1-4.7 0-2.35-1.95-4.05-4.5-4.05-3.35 0-5.15 2.25-5.15 4.65 0 1.15.45 2.2 1.4 2.6.15.05.2.05.25-.1.05-.15.15-.55.2-.7.05-.15 0-.25-.1-.4-.2-.25-.35-.65-.35-1.15 0-1.5 1.15-2.85 2.95-2.85 1.6 0 2.5.95 2.5 2.25 0 1.7-.75 3.15-1.85 3.15-.6 0-1.05-.5-.9-1.15.15-.8.45-1.65.45-2.2 0-.5-.3-.95-.85-.95-.7 0-1.25.7-1.25 1.65 0 .6.2 1 .2 1s-.7 2.95-.85 3.45c-.15.65-.05 1.55-.05 1.65" />
                  </svg>
                </a>
                <a href={LINKEDIN_URL} className="social-link" aria-label="LinkedIn" target="_blank" rel="noreferrer">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                    <rect x="3" y="3" width="18" height="18" rx="2" />
                    <line x1="8" y1="10" x2="8" y2="16" />
                    <line x1="8" y1="8" x2="8" y2="8" />
                    <path d="M12 16v-3.25a1.75 1.75 0 0 1 3.5 0V16" />
