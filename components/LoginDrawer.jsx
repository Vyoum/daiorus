...
export default function LoginDrawer({ open, onClose }) {
  ...
  const handleSubmit = (e) => {
    ...
    setMessage(
      mode === 'login'
        ? 'Sign-in will be available once account access is connected.'
        : 'Account creation will be available once registration is connected.'
    );
  };

  const handleGoogleSignIn = () => {
    setMessage('Google sign-in will be available once account access is connected.');
  };
